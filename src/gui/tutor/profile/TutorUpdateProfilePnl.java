...
import tutormanagementsystem.Subject;
import tutormanagementsystem.Tutor;

public class TutorUpdateProfilePnl extends javax.swing.JPanel {
    private TutorPanelContainer frame;
    private Tutor tutor;
    private Branch branch;

    public TutorUpdateProfilePnl(TutorPanelContainer frame, Tutor tutor) {
        initComponents();
        this.frame = frame;
        this.tutor = tutor;
        ...
        Subject[] subjects = new Subject[tutor.getSubjectIds().length];
        for (int i = 0; i < tutor.getSubjectIds().length; i++) {
            subjects[i] = Main.subjectDatabase.findData(tutor.getSubjectIds()[i]);
        }
        ...
        txtSubjects.setText(Arrays.stream(subjects).map(subject -> subject.getName()).map(String::valueOf).collect(Collectors.joining(",")));
    ...
    private void initComponents() {
        ...
        txtSubjects.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        txtSubjects.setEnabled(false);
            ...
            .addGroup(pnlBranchDetailsLayout.createSequentialGroup()
                ...
                .addGroup(pnlBranchDetailsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlBranchDetailsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(txtSubjects, javax.swing.GroupLayout.Alignment.TRAILING)
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        if (!txtPhoneNumber.getText().isEmpty() && !txtEmail.getText().isEmpty() && !txtBankName.getText().isEmpty() && !txtAccountName.getText().isEmpty() && !txtBankNumber.getText().isEmpty()) {
            ...
            JOptionPane.showMessageDialog(new JFrame(), "Profile Updated Successfully", "Success", JOptionPane.INFORMATION_MESSAGE);
