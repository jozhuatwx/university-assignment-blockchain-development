...
public class TCentreAddTutorPnl extends javax.swing.JPanel {
    private TCentrePanelContainer frame;
    private Branch branch;

    public TCentreAddTutorPnl(TCentrePanelContainer frame, Branch branch) {
        initComponents();
        this.frame = frame;
        this.branch = branch;
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        if (!txtTutorID.getText().isEmpty() && !txtName.getText().isEmpty() && !txtIdentityNumber.getText().isEmpty() && !txtPhoneNumber.getText().isEmpty() && !txtEmail.getText().isEmpty() && !txtBankName.getText().isEmpty() && !txtAccountName.getText().isEmpty() && !txtBankNumber.getText().isEmpty() && !txtPayRate.getText().isEmpty()) {
            // Save tutor data
            Tutor tutor = new Tutor(Double.parseDouble(txtTutorID.getText()), txtName.getText(), txtIdentityNumber.getText(), txtPhoneNumber.getText(), txtEmail.getText(), "", new double[] {cmbSubjects.getSelectedIndex() + 1}, LocalDate.now(), txtBankName.getText(), txtAccountName.getText(), txtBankNumber.getText(), branch.getId(), Double.parseDouble(txtPayRate.getText()), LocalDate.MIN);
