...
public class HQTCentreChangePassPnl extends javax.swing.JPanel {
    private HQPanelContainer frame;
    private Branch branch;

    public HQTCentreChangePassPnl(HQPanelContainer frame, Branch branch) {
        initComponents();
        this.frame = frame;
        this.branch = branch;
    }
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if (!String.valueOf(txtOldPassword.getPassword()).isEmpty() && !String.valueOf(txtNewPassword.getPassword()).isEmpty() && !String.valueOf(txtConfirmNewPassword.getPassword()).isEmpty()) {
            ...
            if (Arrays.equals(txtNewPassword.getPassword(), txtConfirmNewPassword.getPassword())) {
                ...
                if (branch.verify(Main.cryptography, String.valueOf(txtOldPassword.getPassword()))) {
                    ...
                    if (confirmationResult == 0) {
                        // Set updated branch password
                        branch.setPassword(String.valueOf(txtNewPassword.getPassword()), Main.cryptography);
