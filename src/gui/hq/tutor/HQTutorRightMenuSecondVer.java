...
public class HQTutorRightMenuSecondVer extends javax.swing.JPanel {
    private HQPanelContainer frame;

    public HQTutorRightMenuSecondVer(HQPanelContainer frame) {
        initComponents();
        this.frame = frame;
    }
    ...
    private void pnlAddTutorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pnlAddTutorMouseClicked
        ...
        frame.navigateMenuPanel(new HQTutorRightMenu(frame));
