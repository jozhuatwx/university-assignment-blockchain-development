...
public class HQEditTutorPnl extends javax.swing.JPanel {
    private HQPanelContainer frame;
    private Tutor tutor;

    public HQEditTutorPnl(HQPanelContainer frame, Tutor tutor) {
        initComponents();
        this.frame = frame;
        this.tutor = tutor;
        ...
        cmbBranchName.setSelectedItem(Main.branchDatabase.findData(tutor.getBranchId()).getName());
        populateCmbSubjects();
    ...
    private void initComponents() {
        ...
        pnlUpdateTutorContainer = new javax.swing.JPanel();
        btnUpdate = new javax.swing.JButton();
        tabpnlTutor = new javax.swing.JTabbedPane();
        ...
        pnlUpdateTutorContainer.setBackground(new java.awt.Color(242, 242, 242));
        pnlUpdateTutorContainer.setMinimumSize(new java.awt.Dimension(500, 450));
        ...
        tabpnlTutor.setBackground(new java.awt.Color(51, 51, 51));
        ...
        tabpnlTutor.addTab("Personal Details", pnlPersonalDetails);
            ...
            .addGroup(pnlBranchDetailsLayout.createSequentialGroup()
                ...
                .addGroup(pnlBranchDetailsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlBranchDetailsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(txtPayRate, javax.swing.GroupLayout.DEFAULT_SIZE, 189, Short.MAX_VALUE)
                    ...
                    .addComponent(txtTerminatedDate, javax.swing.GroupLayout.PREFERRED_SIZE, 189, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(33, 33, 33))
        );
        ...
        tabpnlTutor.addTab("Branch Details", pnlBranchDetails);
        ...
        tabpnlTutor.addTab("Bank Account Details", pnlBankAccountDetails);

        javax.swing.GroupLayout pnlUpdateTutorContainerLayout = new javax.swing.GroupLayout(pnlUpdateTutorContainer);
        pnlUpdateTutorContainer.setLayout(pnlUpdateTutorContainerLayout);
        pnlUpdateTutorContainerLayout.setHorizontalGroup(
            pnlUpdateTutorContainerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(pnlUpdateTutorContainerLayout.createSequentialGroup()
                .addGroup(pnlUpdateTutorContainerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(pnlUpdateTutorContainerLayout.createSequentialGroup()
                        .addGap(170, 170, 170)
                        .addComponent(btnUpdate, javax.swing.GroupLayout.PREFERRED_SIZE, 148, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(pnlUpdateTutorContainerLayout.createSequentialGroup()
                        .addGap(29, 29, 29)
                        .addComponent(tabpnlTutor, javax.swing.GroupLayout.PREFERRED_SIZE, 441, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(30, Short.MAX_VALUE))
        );
        pnlUpdateTutorContainerLayout.setVerticalGroup(
            pnlUpdateTutorContainerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(pnlUpdateTutorContainerLayout.createSequentialGroup()
                .addGap(18, 18, 18)
                .addComponent(tabpnlTutor)
                .addGap(18, 18, 18)
        ...
        pnlRightBgLayout.setHorizontalGroup(
            ...
            .addGroup(pnlRightBgLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(pnlRightBgLayout.createSequentialGroup()
                    .addGap(44, 44, 44)
                    .addComponent(pnlUpdateTutorContainer, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        if (!txtName.getText().isEmpty() && !txtIdentityNumber.getText().isEmpty() && !txtPhoneNumber.getText().isEmpty() && !txtEmail.getText().isEmpty() && !txtBankName.getText().isEmpty() && !txtAccountName.getText().isEmpty() && !txtBankNumber.getText().isEmpty() && !cmbBranchName.getSelectedItem().toString().isEmpty() && !txtPayRate.getText().isEmpty()) {
            ...
            tutor.setBranchId(Main.branchDatabase.findData(cmbBranchName.getSelectedItem().toString()).getId());
            ...
            // Refresh the page
            frame.navigateMenuPanel(new HQTutorRightMenu(frame, 1));
        } else {
    ...
    private javax.swing.JPanel pnlUpdateTutorContainer;
    private javax.swing.JTabbedPane tabpnlTutor;
