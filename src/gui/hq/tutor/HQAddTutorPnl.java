...
public class HQAddTutorPnl extends javax.swing.JPanel {
    private HQPanelContainer frame;

    public HQAddTutorPnl(HQPanelContainer frame) {
        initComponents();
        this.frame = frame;
        ...
        txtTutorID.setText(String.format("%.0f", Main.tutorDatabase.generateId()));
        txtJoinDate.setText(LocalDate.now().format(Main.DATE_FORMATTER));
    }
    ...
    private void initComponents() {
        ...
        lblEmal = new javax.swing.JLabel();
        ...
        lblEmal.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        lblEmal.setText("Email");
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        if (!txtTutorID.getText().isEmpty() && !txtName.getText().isEmpty() && !txtIdentityNumber.getText().isEmpty() && !txtPhoneNumber.getText().isEmpty() && !txtEmail.getText().isEmpty() && !txtBankName.getText().isEmpty() && !txtAccountName.getText().isEmpty() && !txtBankNumber.getText().isEmpty() && !cmbBranchName.getSelectedItem().toString().isEmpty() && !txtPayRate.getText().isEmpty()) {
            // Save tutor data
            Tutor tutor = new Tutor(Double.parseDouble(txtTutorID.getText()), txtName.getText(), txtIdentityNumber.getText(), txtPhoneNumber.getText(), txtEmail.getText(), "", new double[] {cmbSubjects.getSelectedIndex() + 1}, LocalDate.now(), txtBankName.getText(), txtAccountName.getText(), txtBankNumber.getText(), Main.branchDatabase.findData(cmbBranchName.getSelectedItem().toString()).getId(), Double.parseDouble(txtPayRate.getText()), LocalDate.MIN);
            // Set default password
            tutor.setPassword(Main.DEFAULT_PASSWORD, Main.cryptography);
            Main.tutorDatabase.add(tutor);

            // Display success message
            JOptionPane.showMessageDialog(new JFrame(), "Tutor Added Successfully", "Success", JOptionPane.INFORMATION_MESSAGE);
    ...
    private javax.swing.JLabel lblEmal;
